...
final class RRSIG extends Type {
		...
		public function decode( ByteOperations $byteOperations, array $ansHeader ): void {
				...
				$this->extras['signature_expiration'] = new DateTimeImmutable( '@' . $this->extras['signature_expiration'] );
				$this->extras['signature_inception']  = new DateTimeImmutable( '@' . $this->extras['signature_inception'] );
